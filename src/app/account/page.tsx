      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-8">
            <div className="mb-8 text-center">
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#fed700]/20 mb-4">
                <Lock className="w-6 h-6 text-[#c9a900]" />
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link href="#" className="text-xs text-[#0b4a77] dark:text-sky-400 hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
              ...
              <label className="flex items-center gap-2.5 cursor-pointer select-none">
                <input
                  ...
                  className="w-4 h-4 rounded border-gray-300 dark:border-gray-600 accent-[#fed700]"
                />
          ...
          <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
            ...
            <Link href={ROUTES.REGISTER} className="text-[#0b4a77] dark:text-sky-400 font-semibold hover:underline">
              Create one
            </Link>
          </p>
        </div>
