...
const ProductDisplay_V = ({ product }: { product: Product }) => {
    ...
    return (
        <div style={{height: '330px'}} className="flex flex-col  justify-between group cursor-pointer bg-white dark:bg-gray-950 h-full">
        ...
        <div className="relative h-48 flex items-center justify-center">
            <img
                ...
                className="object-contain p-6 w-full h-full group-hover:scale-105 transition-transform duration-300"
            />
        </div>
